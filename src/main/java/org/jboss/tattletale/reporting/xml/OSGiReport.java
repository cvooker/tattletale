...
import org.jboss.tattletale.reporting.abstracts.OSGiReportAbstract;
 ...
 */
public class OSGiReport extends OSGiReportAbstract
{
   /** NAME */
   ...
   public void generate(String outputDirectory)
   {
      ...
      try
      {
         for (Archive archive : archives)
         {
            ...
            File archiveOutput = writeArchiveOSGI(archive, osgiInformation);
   ...
   private File writeArchiveOSGI(Archive archive, List<String> osgiInformation) throws IOException
   {
